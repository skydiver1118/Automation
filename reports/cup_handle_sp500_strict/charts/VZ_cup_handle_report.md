# VZ Cup-And-Handle Weekly Scan

Data source: yfinance weekly OHLCV, generated through 2026-05-25.
One-year chart: VZ_weekly_cup_handle_1y.png
Pattern-context chart: VZ_weekly_cup_handle_context.png
...
| Score | 77.34/100 |
| Latest weekly close | 47.81 on 2026-05-25 |
| Breakout trigger | Weekly close above 48.96 (+2.4% from latest close) |
| Potential measured target | 59.22 (+23.9% from latest close, if breakout confirms) |
| Handle risk / invalidation area | Below handle low 45.81 (-4.2% from latest close) |
...
| --- | --- | ---: | --- |
| 1st Pivot | 2025-03-10 | 47.36 | Left rim of the cup. |
| Cup | 2025-10-20 | 38.39 | Low point of the cup. |
| 2nd Pivot | 2026-04-27 | 48.65 | Right rim / resistance area. |
| Handle | 2026-05-18 | 45.81 | Handle pullback low. |
| Handle End | 2026-05-25 | 48.96 | Breakout level to watch. |
| Measured target | n/a | 59.22 | Breakout level plus cup depth. |

## Pattern Quality

| Check | Result | Read |
| --- | ---: | --- |
| Cup depth | 21.09% | Deep but still within the script's loose scan range. |
| Cup width | 59 weeks | Long enough to qualify as a weekly base candidate. |
| Handle width | 4 weeks | Short/current handle; still forming. |
| Handle depth | 27.68% of cup depth | Pullback is deeper than ideal, so confirmation matters. |
| Rim gap | 2.65% | Right rim is below the left rim; this weakens symmetry. |
| Ideal upper-half handle floor | 43.52 | Handle quality improves if it holds above this zone. |
| Volume | n/a | handle avg volume 0.95x cup avg; latest week 1.21x handle avg. |

## Interpretation

- TSLA currently fits the video-style scanner bucket `Cup and Handle Pattern in Force`.
- The bullish trigger is a weekly breakout above `48.96`.
- A simple measured target after confirmation is `59.22`.
- The setup weakens if price loses the handle low near `45.81`.
...
| ---: | ---: | --- | --- | ---: |
| 1 | 77.34 | Cup and Handle Pattern in Force | 2025-03-10 -> 2025-10-20 -> 2026-04-27; handle low 2026-05-18 | 48.96 |
| 2 | 72.29 | Cup and Handle Pattern in Force | 2025-03-31 -> 2025-10-20 -> 2026-04-27; handle low 2026-05-18 | 48.96 |
| 3 | 62.94 | Cup and Handle Pattern in Force | 2025-08-18 -> 2025-12-22 -> 2026-04-27; handle low 2026-05-18 | 48.96 |
| 4 | 62.64 | Cup and Handle Pattern in Force | 2025-08-18 -> 2026-01-19 -> 2026-04-27; handle low 2026-05-18 | 48.96 |
