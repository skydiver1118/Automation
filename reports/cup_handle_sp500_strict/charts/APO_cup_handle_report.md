# APO Cup-And-Handle Weekly Scan

Data source: yfinance weekly OHLCV, generated through 2026-05-25.
One-year chart: APO_weekly_cup_handle_1y.png
Pattern-context chart: APO_weekly_cup_handle_context.png
...
| Score | 77.54/100 |
| Latest weekly close | 128.71 on 2026-05-25 |
| Breakout trigger | Weekly close above 136.58 (+6.1% from latest close) |
| Potential measured target | 174.05 (+35.2% from latest close, if breakout confirms) |
| Handle risk / invalidation area | Below handle low 126.08 (-2.0% from latest close) |
...
| --- | --- | ---: | --- |
| 1st Pivot | 2025-11-10 | 137.03 | Left rim of the cup. |
| Cup | 2026-03-02 | 99.56 | Low point of the cup. |
| 2nd Pivot | 2026-05-11 | 136.58 | Right rim / resistance area. |
| Handle | 2026-05-25 | 126.08 | Handle pullback low. |
| Handle End | 2026-05-25 | 136.58 | Breakout level to watch. |
| Measured target | n/a | 174.05 | Breakout level plus cup depth. |

## Pattern Quality

| Check | Result | Read |
| --- | ---: | --- |
| Cup depth | 27.34% | Deep but still within the script's loose scan range. |
...
| Handle depth | 28.02% of cup depth | Pullback is deeper than ideal, so confirmation matters. |
| Rim gap | 0.33% | Right rim is below the left rim; this weakens symmetry. |
| Ideal upper-half handle floor | 118.30 | Handle quality improves if it holds above this zone. |
| Volume | n/a | handle avg volume 0.76x cup avg; latest week 1.06x handle avg. |

## Interpretation

- TSLA currently fits the video-style scanner bucket `Cup and Handle Pattern in Force`.
- The bullish trigger is a weekly breakout above `136.58`.
- A simple measured target after confirmation is `174.05`.
- The setup weakens if price loses the handle low near `126.08`.
...
| ---: | ---: | --- | --- | ---: |
| 1 | 77.54 | Cup and Handle Pattern in Force | 2025-11-10 -> 2026-03-02 -> 2026-05-11; handle low 2026-05-25 | 136.58 |
| 2 | 61.69 | Cup and Handle Pattern in Force | 2025-12-08 -> 2026-03-02 -> 2026-05-11; handle low 2026-05-25 | 136.58 |
