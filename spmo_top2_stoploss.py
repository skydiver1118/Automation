...
TOP_N              = 2
STOP_LOSS          = 0.08    # 8% below entry open
START_DT           = "2020-01-01"
END_DT             = "2024-12-31"
...
# ── 8. Print ───────────────────────────────────────────────────────────────
print("\n" + "="*80)
print("  TOP-2 WITHIN SPMO UNIVERSE  |  8% STOP-LOSS vs NO STOP  |  2020–2024")
print("="*80)
...
# Monthly detail
print(f"\n{'='*90}")
print(f"  TOP-2 + 8% STOP-LOSS  MONTHLY DETAIL")
print(f"{'='*90}")
...
# ── 9. Save Excel ──────────────────────────────────────────────────────────
out_path = "spmo_top2_stoploss_2020_2024.xlsx"
